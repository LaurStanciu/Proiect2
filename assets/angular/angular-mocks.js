 ...
 *
  ...
  function MyController($scope, $http) {
    ...
    $scope.saveMessage = function(message) {
      ...
      $http.post('/add-message.py', message, { headers: headers } ).then(function(response) {
        $scope.status = '';
      }).catch(function() {
        $scope.status = 'Failed...';
      });
  ...
  ```js
    ...
    describe('MyController', function() {
       ...
       it('should send message to server', function() {
         ...
         $httpBackend.expectPOST('/add-message.py', 'message content').respond(201, '');
       ...
       it('should send auth header', function() {
         ...
         $httpBackend.expectPOST('/add-message.py', undefined, function(headers) {
